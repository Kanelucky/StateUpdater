...
public class BlockStateUpdater_1_26_50 extends BlockStateUpdater {
    ...
    public void registerUpdaters(BlockUpdaterContext context) {
        for (String stairs : STAIRS) {
            context.addProperty("minecraft:" + stairs, "minecraft:corner", "none");
        }
        for (String connectable : CONNECTABLES) {
            String name = "minecraft:" + connectable;
            context.addProperty(name, "minecraft:connection_north", (byte) 0);
            context.addProperty(name, "minecraft:connection_east", (byte) 0);
            context.addProperty(name, "minecraft:connection_south", (byte) 0);
            context.addProperty(name, "minecraft:connection_west", (byte) 0);
        }
    }
}
